...
APracticeCharacter::APracticeCharacter(const class FPostConstructInitializeProperties& PCIP)
	: Super(PCIP)
{
...
void APracticeCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	// set up gameplay key bindings
	InputComponent->BindAction("Jump", IE_Pressed, this, &ACharacter::Jump);
	InputComponent->BindAxis("MoveRight", this, &APracticeCharacter::MoveRight);

	InputComponent->BindTouch(IE_Pressed, this, &APracticeCharacter::TouchStarted);
}
...
void APracticeCharacter::TouchStarted(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	// jump on any touch
	Jump();
}
